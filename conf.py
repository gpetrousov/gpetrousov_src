...
BLOG_AUTHOR = "Ioannis Petrousov"  # (translatable)
BLOG_TITLE = "Ioannis Petrousov"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://gpetrousov.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://localhost:8000/"
BLOG_EMAIL = "petrousov@gmail.com"
BLOG_DESCRIPTION = "I mostly keep to myself, but sometimes..."  # (translatable)
...
# is in the manual.
COMMENT_SYSTEM_ID = "@giannispetrousov"
